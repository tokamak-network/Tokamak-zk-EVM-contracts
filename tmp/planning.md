...
- Complete the data-category matrix for every inventoried Privacy Notice surface before moving to Phase 2 redline work.
  The surface inventory is complete enough for the current planning pass, but data categories, processing purposes,
  retention, sharing, storage locations, international transfers, and user deletion/access routes remain incomplete.
...
| Privacy Notice | Highest priority, unresolved. | Complete the Privacy Notice data-category matrix and draft before final Terms, guide, JSON mode, or implementation work. |
