...
1. Groth16 MPC setup and publisher write generated artifacts inside the package
...
2. Private-state local tooling writes logs and E2E output inside the app directory
...
3. Repository deployment helpers write generated deployment artifacts under the repository root
...
4. Groth16 trusted-setup source is retained for compatibility
...
5. Groth16 CLI accepts `--docker` for command parity only
...
6. Bridge deployment mode compatibility logic remains active
...
7. Root-level legacy deployment wrappers were already removed
...
8. No clearly unused repository-owned script entrypoint was found
