...
contract MerkleTreeManager4Test is Test {
    ...
    function testVerifyProof() public {
        ...
        bytes32 leaf = merkleTree.computeLeafForVerification(address(0x111), 100, bytes32(0));
    ...
    function testHashFourEdgeCases() public view {
        ...
        bytes32 result4 =
            merkleTree.hashFour(bytes32(uint256(1)), bytes32(uint256(2)), bytes32(uint256(3)), bytes32(uint256(4)));
