...
1. Private-state local tooling writes logs and E2E output inside the app directory
...
2. Repository deployment helpers write generated deployment artifacts under the repository root
...
3. Groth16 trusted-setup source is retained for compatibility
