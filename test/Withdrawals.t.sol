...
contract WithdrawalsTest is Test {
    ...
    ) internal returns (WithdrawalProofData memory) {
    ...
    function _getWithdrawalProofForAll(
        uint256 channelId,
        address userL2Address,
        bytes32 finalStateRoot
    ) internal returns (WithdrawalProofData memory) {
    ...
    function testTokenWithdrawalSuccess() public {
        ...
        bytes32 expectedLeaf = rollupBridge.computeLeafForVerification(
            l2Address2,
            DEPOSIT_AMOUNT, 
            finalStateRoot
        );
    ...
    function testComputeLeafCompatibility() public {
        ...
        bytes32 contractLeafWithLastRoot = rollupBridge.computeLeafForVerification(
            l2Address1,
            DEPOSIT_AMOUNT,
            lastRootInSequence
        );
        ...
        bytes32 contractLeafWithFinalRoot = rollupBridge.computeLeafForVerification(
            l2Address1,
            DEPOSIT_AMOUNT,
            finalStateRoot
        );
