...
contract StateTransitionVerifier is IStateTransitionVerifier, Ownable {
    ...
    function verifyAndCommitStateUpdate(StateUpdate calldata update) external returns (bool) {
        ...
        _verifyParticipantSignatures(update, channelInfo.participants, channelInfo.signatureThreshold);
    ...
    function _verifyParticipantSignatures(StateUpdate calldata update, address[] memory participants, uint256 threshold)
        internal
        pure
    {
