...
component main{public [root_before, root_after, leaf_index, storage_key_before, storage_value_before, storage_key_after, storage_value_after]} = updateTree(12);
