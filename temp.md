...
1. Duplicate Groth16 MPC setup utility logic
...
2. Large inline Node blocks inside bridge deployment shell script
...
3. Manual provenance verification script has low discoverability
...
4. Groth16 trusted-setup path is retained for compatibility
