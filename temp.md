...
1. Repository deployment helpers write generated deployment artifacts under the repository root
...
2. Groth16 trusted-setup source is retained for compatibility
...
3. Groth16 CLI accepts `--docker` for command parity only
...
4. Bridge deployment mode compatibility logic remains active
...
5. Root-level legacy deployment wrappers were already removed
...
6. No clearly unused repository-owned script entrypoint was found
