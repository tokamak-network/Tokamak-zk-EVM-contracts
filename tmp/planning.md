...
- Terms and docs must describe the refund schedule as time-increasing, so early exits have a larger non-refundable
  burn-address-transfer portion than later exits.
