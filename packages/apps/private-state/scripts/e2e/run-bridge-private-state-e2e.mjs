...
const groth16CliPath = path.resolve(repoRoot, "packages", "groth16", "cli", "tokamak-groth16-cli.mjs");
...
function usage() {
  console.log(`Usage:
  node packages/apps/private-state/scripts/e2e/run-bridge-private-state-e2e.mjs [options]
