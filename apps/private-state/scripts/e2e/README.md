...
```bash
node apps/private-state/scripts/e2e/run-bridge-private-state-e2e.mjs
...
`apps/private-state/scripts/e2e/output/private-state-bridge-genesis`

The CLI-driven harness writes its final summary under:

`apps/private-state/scripts/e2e/output/private-state-bridge-cli/summary.json`
