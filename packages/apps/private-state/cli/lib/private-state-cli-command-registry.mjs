...
export const PRIVATE_STATE_CLI_COMMANDS = Object.freeze([
  ...
  },
  {
    ...
    usage: "--amount, --network, --account, --acknowledge-action-impact",
    help: [
      "Action impact: emits a public Ethereum mainnet bridge withdrawal event that exposes the local Ethereum recipient, bridge vault, amount, and transaction hash.",
  ...
  },
  {
    ...
    help: [
      ...
      "Action impact: emits public proof-backed bridge/channel accounting events exposing the Ethereum submitter, registered channel-local address, amount, channel id, and transaction hash.",
      "Private note state is not changed by this command.",
      ACTION_IMPACT_HELP.policy,
      ACTION_IMPACT_HELP.secretRecovery,
      ACTION_IMPACT_HELP.illegalUse,
