...
e([B]_1,[\alpha^4]_2)
=
e([O_{pub,fix}]_1 + [O_{pub,free}]_1,[\gamma]_2)
e([O_{mid}]_1,[\eta]_2)
...
[LHS_B]_1 := (1+\kappa_2\kappa_1^4)[A_{free}]_1-\kappa_2\kappa_1^4A_{eval}[1]_1,\\
...
|---|---|---|
| 1 | $1+\kappa_2\kappa_1^4$ | $[A_{free}]_1$ |
...
| 16 | $-\kappa_2\kappa_1^4A_{eval}-\kappa_2\kappa_1V_{x,y}-\kappa_2\kappa_1^3R_{x,y}-\kappa_2^2R'_{x,y}-\kappa_2^3R''_{x,y}+\theta_2(C_G+C_F)$ | $[1]_1$ |
