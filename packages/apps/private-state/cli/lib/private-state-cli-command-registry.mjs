...
const ACTION_IMPACT_HELP = Object.freeze({
  ...
  exchangeAddress: "Do not use an exchange-controlled address as a self-custody bridge source or direct bridge withdrawal target.",
...
export const PRIVATE_STATE_CLI_COMMANDS = Object.freeze([
  ...
  },
  {
    ...
    help: [
      ...
      ACTION_IMPACT_HELP.exchangeAddress,
