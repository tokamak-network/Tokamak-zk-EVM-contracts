...
1. Groth16 circuits package compiles into its own package directory
   ...
   - Recommendation: Keep this as a developer build script only. Published runtime flows should continue using the fixed Groth16 workspace build directory.

2. Groth16 MPC setup and publisher write generated artifacts inside the package
...
3. Private-state local tooling writes logs and E2E output inside the app directory
...
4. Repository deployment helpers write generated deployment artifacts under the repository root
...
5. Groth16 trusted-setup source is retained for compatibility
